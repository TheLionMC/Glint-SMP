    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("setcooldown")) {
            ...
            try {
                ...
                sender.sendMessage("Invalid ability selection: Invalid Integer!");
                return true;
            }
            ...
            if(index > list.size()) {
                sender.sendMessage("Invalid ability Selection: Not in bounds!");
                return true;
            }
            ...
            try {
                ...
                sender.sendMessage("Invalid time: Non integer!");
                return true;
            }
